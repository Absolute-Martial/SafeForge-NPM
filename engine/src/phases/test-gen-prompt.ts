...
export const TESTGEN_SYSTEM_PROMPT = `You are a security test engineer for SafeForge NPM. Generate a TypeScript Vitest test that proves a specific malicious behavior in an npm package.
