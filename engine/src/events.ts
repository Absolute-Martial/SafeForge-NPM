...
export interface CliBehaviorStarted extends AuditEvent {
  type: "cli_behavior_started";
  commands: CliBehaviorReport["commandsDiscovered"];
  nodeVersions: string[];
}
export interface CliCommandResultEvent extends AuditEvent {
  type: "cli_command_result";
  result: CliCommandResult;
}
export interface DependencyGraphReady extends AuditEvent {
  type: "dependency_graph_ready";
  graph: DependencyGraphReport;
}
export interface AdvisoryScanStarted extends AuditEvent {
  type: "advisory_scan_started";
  nodeCount: number;
}
export interface AdvisoryMatchEvent extends AuditEvent {
  type: "advisory_match";
  advisory: AdvisoryRecord;
}
export interface AdvisorySummaryEvent extends AuditEvent {
