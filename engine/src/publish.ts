...
export async function publishAuditResults(
  ...
  const reportDir = fs.mkdtempSync(path.join(os.tmpdir(), "safeforge-npm-report-"));
  ...
  // packagePath is /tmp/safeforge-npm-xxx/extracted/package — tgz is at /tmp/safeforge-npm-xxx/package.tgz
