...
const PARENT_TEXT_KEYS = [
  "safeforge-npm.latest_version",
  "safeforge-npm.latest_verdict",
  "safeforge-npm.latest_score",
  "safeforge-npm.latest_report_cid",
  "safeforge-npm.latest_report_uri",
  "safeforge-npm.latest_source_cid",
  "safeforge-npm.latest_source_uri",
  "safeforge-npm.latest_capabilities",
  "safeforge-npm.latest_date",
];
...
async function main() {
  console.log("=== SafeForge NPM Cleanup ===\n");
